========================================================================
    KONSOLENANWENDUNG: uebung0-Projektübersicht
========================================================================

Diese uebung0-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre uebung0-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen uebung0.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
